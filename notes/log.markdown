...
```
  ...
  db/log_writer.h/cc -> Writer/WritableFile
  util/env_posix.cc  -> PosixWritableFile()
```
...
先介绍下日志的数据格式(db/log_format.h)，如图:
...
```
$ xxd log_writer_blob.data | head
                    little-endian
00000000: 52e4 9787 ef7f 0161 6161 6161 6161 6161  R......aaaaaaaaa
