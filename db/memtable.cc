...
void MemTable::Add(SequenceNumber s, ValueType type, const Slice& key,
  ...
  // 参考 图 https://izualzhy.cn/memtable-leveldb#2-%E5%AD%98%E5%82%A8%E7%9A%84%E6%95%B0%E6%8D%AE%E6%A0%BC%E5%BC%8F
  table_.Insert(buf);
}
...
bool MemTable::Get(const LookupKey& key, std::string* value, Status* s) {
  ...
  iter.Seek(memkey.data());   // skiplist通过 InternalKeyComparator::Compare (比较key 查找value)  key按照用户的定义进行排序
  if (iter.Valid()) {
    // entry format is:
    //    klength  varint32
